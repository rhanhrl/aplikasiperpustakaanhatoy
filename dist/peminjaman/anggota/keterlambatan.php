    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                ?>
                <p>Perpustakaan menerapkan aturan waktu peminjaman buku selama <?php echo $waktu_peminjaman; ?> hari dihitung sejak tanggal peminjaman. Apabila melebihi waktu tersebut maka akan dikenakan denda keterlambatan sebesar Rp.<?php echo number_format($denda_keterlambatan,0,',','.');?>/Hari.</p>
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php
                            ...
                            inner join buku k on k.kode_buku=d.kode_buku
