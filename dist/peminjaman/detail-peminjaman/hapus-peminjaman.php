...
session_start();
    ...
    if ($cek==0){
        ...
        if ($hapus_detail_peminjaman and $hapus_peminjaman) {
            ...
            header("Location:../../../dist/halaman.php?page=daftar-peminjaman&hapus-peminjaman=berhasil");
        }
        else {
            mysqli_query($kon,"ROLLBACK");
            header("Location:../../../dist/halaman.php?page=daftar-peminjaman&hapus-peminjaman=gagal");
        }
    } else {

        if ($hapus_detail_peminjaman) {
            mysqli_query($kon,"COMMIT");
            header("Location:../../../dist/halaman.php?page=detail-peminjaman&kode_peminjaman=$kode_peminjaman&hapus-peminjaman=berhasil&#bagian_peminjaman");
        }
        else {
            mysqli_query($kon,"ROLLBACK");
            header("Location:../../../dist/halaman.php?page=detail-peminjaman&id_peminjaman=$id_peminjaman&hapus-peminjaman=gagal&#bagian_peminjaman");
        }
