...
if (isset($_POST['edit_anggota'])) {
    ...
    if ($edit_peminjaman_anggota) {
        ...
        header("Location:../../halaman.php?page=detail-peminjaman&kode_peminjaman=$kode_peminjaman&edit-anggota=berhasil");
    }
    else {
        mysqli_query($kon,"ROLLBACK");
        header("Location:../../halaman.php?page=detail-peminjaman&kode_peminjaman=$kode_peminjaman&edit-anggota=gagal");
