<?php
    ...
    $pdf->Cell(72,6,'Judul Buku',1,0,'C');
    ...
    if (isset($_GET['kode_peminjaman']) and $_GET['kode_peminjaman']!=''){
        ...
        inner join buku on buku.kode_buku=detail_peminjaman.kode_buku where peminjaman.kode_peminjaman='$kode_peminjaman'";
    }else if (isset($_GET['kode_anggota'])){
        $kode_anggota=$_GET['kode_anggota'];
        $sql="select * from detail_peminjaman inner join peminjaman on peminjaman.kode_peminjaman=detail_peminjaman.kode_peminjaman
        inner join buku on buku.kode_buku=detail_peminjaman.kode_buku where kode_anggota='$kode_anggota'";
    }
    ...
    while ($data = mysqli_fetch_array($hasil)){
        ...
        //Menampilkan data
        $pdf->Cell(8,6,$no,1,0);
        $pdf->Cell(72,6,$data['judul_buku'],1,0);
