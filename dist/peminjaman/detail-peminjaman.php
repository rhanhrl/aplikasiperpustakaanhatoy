        ...
        <?php
            ...
            if (isset($_GET['edit-anggota'])) {
                if ($_GET['edit-anggota']=='berhasil'){
                    echo"<div class='alert alert-success'><strong>Berhasil!</strong> Anggota yang meminjam buku berhasil diupdate</div>";
                } else if ($_GET['edit-anggota']=='gagal'){
                    echo"<div class='alert alert-danger'><strong>Gagal!</strong> Anggota yang meminjam buku gagal diupdate</div>";
                }   
            }
        ?>
        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table class="table table">
                                    ...
                                    <?php
                                        ...
                                        left join buku pk on pk.kode_buku=dp.kode_buku
                            ...
                            <?php
                                    ...
                                    if (isset($_GET['edit-peminjaman'])) {
                                        if ($_GET['edit-peminjaman']=='berhasil'){
                                            echo"<div class='alert alert-success'><strong>Berhasil!</strong> Buku berhasil diupdate</div>";
                                        } else if ($_GET['edit-peminjaman']=='gagal'){
                                            echo"<div class='alert alert-danger'><strong>Gagal!</strong> Buku gagal diupdate</div>";
                                        }   
                                    }
                                    ...
                                    if (isset($_GET['hapus-peminjaman'])) {
                                        if ($_GET['hapus-peminjaman']=='berhasil'){
                                            echo"<div class='alert alert-success'><strong>Berhasil!</strong> Buku telah dihapus</div>";
                                        } else if ($_GET['hapus-peminjaman']=='gagal'){
                                            echo"<div class='alert alert-danger'><strong>Gagal!</strong> Buku gagal dihapus</div>";
                                        }    
                                    }
                                    ...
                                    if (isset($_GET['konfirmasi'])) {
                                        if ($_GET['konfirmasi']=='tolak'){
                                            echo"<div class='alert alert-warning'><strong>Gagal!</strong> Tindakan ditolak karena telah mencapai batas maksimal peminjaman. <a href='#' kode_anggota='". $kode_anggota."' id='lihat_detail_peminjaman'>Lihat daftar buku yang sedang dipinjam</a></div>";
                                        } 
                                    }
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    $sql1 = "SELECT * FROM detail_peminjaman 
                                            INNER JOIN peminjaman ON peminjaman.kode_peminjaman = detail_peminjaman.kode_peminjaman
                                            INNER JOIN buku ON buku.kode_buku = detail_peminjaman.kode_buku 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="tombol_konfirmasi btn btn-info btn-circle" kode_anggota="<?php echo $kode_anggota; ?>" kode_buku="<?php echo $ambil['kode_buku']; ?>"  id_detail_peminjaman="<?php echo $ambil['id_detail_peminjaman']; ?>"  kode_peminjaman="<?php echo $_GET['kode_peminjaman']; ?>"  tanggal_pinjam="<?php echo $ambil['tanggal_pinjam']; ?>" status="<?php echo $ambil['status'];?>" jenis_denda="<?php echo $ambil['jenis_denda'];?>" denda="<?php echo $ambil['denda'];?>" ><i class="fas fa-check"></i></button>
                                            <button class="tombol_edit_peminjaman btn btn-warning btn-circle" id_detail_peminjaman="<?php echo $ambil['id_detail_peminjaman']; ?>" kode_peminjaman="<?php echo $_GET['kode_peminjaman']; ?>"  kode_buku="<?php echo $ambil['kode_buku']; ?>" ><i class="far fa-edit"></i></button>
...
<script>
    ...
    $('.tombol_edit_peminjaman').on('click',function(){
        ...
        $.ajax({
            ...
            method: 'post',
            data: {id_detail_peminjaman:id_detail_peminjaman,kode_peminjaman:kode_peminjaman,kode_buku:kode_buku,tanggal_pinjam:tanggal_pinjam},
            success:function(data){
                $('#tampil_data').html(data);  
                document.getElementById("judul").innerHTML='Edit Buku';
            }
        });
        // Membuka modal
        $('#modal').modal('show');
    ...
    $('.tombol_konfirmasi').on('click',function(){
        ...
        $.ajax({
            ...
            method: 'post',
            data: {kode_anggota:kode_anggota,id_detail_peminjaman:id_detail_peminjaman,kode_peminjaman:kode_peminjaman,kode_buku:kode_buku,tanggal_pinjam:tanggal_pinjam,status:status,jenis_denda:jenis_denda,denda:denda},
            success:function(data){
                $('#tampil_data').html(data);  
    ...
    // edit penyewa
     $('#tombol_edit_anggota').on('click',function(){
        ...
        $.ajax({
            ...
            success:function(data){
                $('#tampil_data').html(data);  
                document.getElementById("judul").innerHTML='Edit Peminjaman Buku';
            }
        });
        // Membuka modal
        $('#modal').modal('show');
    ...
    $('.btn-hapus-Peminjaman').on('click',function(){
        ...
        $.ajax({
            ...
            success:function(data){
                $('#tampil_data').html(data);  
                document.getElementById("judul").innerHTML='Daftar Buku yang Sedang Dipinjam';
            }
        });
        // Membuka modal
        $('#modal').modal('show');
