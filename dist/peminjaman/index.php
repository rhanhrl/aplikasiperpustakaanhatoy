...
<main>
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            ...
            <a href="halaman.php?page=input-peminjaman" class="btn btn-success" role="button">Input Peminjaman</a>
            <?php endif; ?>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="tabel_peminjaman" width="100%" cellspacing="0">
                        ...
                        <?php
                            ...
                            $sql="select p.kode_peminjaman,an.nama_anggota,count(*) as jumlah_buku, p                   .tanggal
                            from peminjaman p
                            ...
                            inner join buku pk on pk.kode_buku=dp.kode_buku
                        ...
                        <tr>
                            ...
                            <td><?php echo $data['jumlah_buku']; ?> Buku</td>
                            <td>
                                <a href="halaman.php?page=detail-peminjaman&kode_peminjaman=<?php echo $data['kode_peminjaman']; ?>" class="btn btn-info btn-circle"><i class="fas fa-mouse-pointer"></i></a>
