            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>Pengajuan peminjaman buku pada hari ini <?php echo tanggal($tanggal); ?> telah berhasil. Selanjutnya anda diwajibkan untuk datang pada hari dan jam kerja (maksimal 1 x 48 jam) dengan membawa identitas/kartu anggota lalu tunjukan kode peminjaman berikut ini kepada petugas</p>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <?php
                            ...
                            inner join detail_peminjaman d on d.kode_buku=p.kode_buku
