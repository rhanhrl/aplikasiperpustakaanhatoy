    ...
    if (isset($_POST['tambah_karyawan'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($simpan_karyawan and $simpan_pengguna) {
                ...
                header("Location:../../dist/halaman.php?page=karyawan&add=berhasil");
            }
            else {
    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            ...
            <label>Nomor Induk Pegawai (NIP):</label>
                <input type="text"  class="form-control" name="nip" placeholder="Masukan Nomor Induk Pegawai" required>
            </div>
        </div>
    </div>
    <div class="row">
