...
session_start();
    ...
    $pdf->SetTitle("DATA BUKU ".strtoupper($row['nama_aplikasi']));
    ...
    $pdf->Cell(0,7,'LAPORAN BUKU',0,1,'C');
    $pdf->Cell(10,4,'',0,1);
    $pdf->SetFont('Arial','B',10);
    ...
    while ($data = mysqli_fetch_array($hasil)):
        ...
        $pdf->Cell(7,6,$no,1,0);
        $pdf->Cell(13,6,$data['kode_buku'],1,0);
        $pdf->Cell(75,6,substr($data['judul_buku'],0,48),1,0);
        $pdf->Cell(25,6,$data['nama_kategori_buku'],1,0);
