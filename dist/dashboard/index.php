...
<main>
    <div class="container-fluid">
        <h2 class="mt-4">Selamat Datang di Web Perpustakaan SMA Hayatan Thayyibah</h2>
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="col-auto">
                        <i class="fa-solid fa-book-open fa-2x text-dark-300"></i>
                    </div>
                    </div>
                </div>
                </div>
            ...
            <?php 
                $hasil=mysqli_query($kon,"select kode_buku from buku");
                $jumlah_buku = mysqli_num_rows($hasil);
            ?>
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card bg-info text-white mb-4">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs text-white text-uppercase mb-1">Jumlah Buku</div>
                        <div class="h5 mb-0 font-weight-bold text-dark-800"><?php echo $jumlah_buku;?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="col-auto">
                        <i class="fa-solid fa-money-bills fa-2x text-dark-300"></i>
                    </div>
                    </div>
                </div>
                </div>
