...
if (isset($_POST['simpan_tambah'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $password = password_hash(input($_POST["password"]), PASSWORD_DEFAULT); // Hashing the password
        ...
        $level = "Anggota";
        $sql1 = "INSERT INTO pengguna (kode_pengguna, status, level, username, password) VALUES
            ('$kode_anggota', '$status', '$level', '$username', '$password')"; // Modified query to include password
