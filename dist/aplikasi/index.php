...
<main>
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Informasi mengenai profil aplikasi dan aturan perpustakaan</li>
        </ol>
        <?php
                        ...
                        <!-- Card Header - Dropdown -->
                            ...
                            <div class="card-body">
                                <form action="aplikasi/edit.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>Maksimal Peminjaman: <span id="info_maksimal_pinjam"><?php if (isset( $data['maksimal_peminjaman'])) echo $data['maksimal_peminjaman'];?> Buku</span> </label>
...
<script>
    ...
    $('#maksimal_pinjam').bind('keyup', function () {
        ...
        $("#info_maksimal_pinjam").text(maksimal_pinjam+' Buku');     
    }); 
