...
<main>
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Data buku yang ada di perpustakaan</li>
        </ol>

        <?php
            //Validasi untuk menampilkan pesan pemberitahuan saat user menambah buku
            if (isset($_GET['add'])) {
                //Mengecek nilai variabel add yang telah di enskripsi dengan method md5()
                if ($_GET['add']=='berhasil'){
                    echo"<div class='alert alert-success'><strong>Berhasil!</strong> Data Buku telah ditambah!</div>";
                }else if ($_GET['add']=='gagal'){
                    echo"<div class='alert alert-danger'><strong>Gagal!</strong> Data Buku gagal ditambahkan!</div>";
            ...
            if ($_GET['edit']=='berhasil'){
                echo"<div class='alert alert-success'><strong>Berhasil!</strong> Data Buku telah diupdate!</div>";
            }else if ($_GET['edit']=='gagal'){
                echo"<div class='alert alert-danger'><strong>Gagal!</strong> Data Buku gagal diupdate!</div>";
            }    
            }
            if (isset($_GET['hapus'])) {
            //Mengecek notifikasi hapus
            if ($_GET['hapus']=='berhasil'){
                echo"<div class='alert alert-success'><strong>Berhasil!</strong> Data Buku telah dihapus!</div>";
            }else if ($_GET['hapus']=='gagal'){
                echo"<div class='alert alert-danger'><strong>Gagal!</strong> Data Buku gagal dihapus!</div>";
            }    
            }
        ?>
        <div class="card mb-4">
            <div class="card-body">
                <form id="form_pencarian_buku">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="sel1">Kategori:</label>
                                <select class="form-control select2" multiple="multiple" name="kategori_buku[]">
                                    <?php
...
<script>
    ...
    $('#btn-cari').on('click',function(){
        ...
        var data = $('#form_pencarian_buku').serialize();
        $.ajax({
            type	: 'POST',
            url: 'pustaka/tampil-pustaka.php',
            data: data,
